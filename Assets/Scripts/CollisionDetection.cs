...
public class CollisionDetection : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        } else if(collision.gameObject.name == "variableInt" && !(gameObject.name == "ValueInt") || collision.gameObject.name == "variableString" && !(gameObject.name == "ValueString") || collision.gameObject.name == "variableFloat" && !(gameObject.name == "ValueFloat"))
        {  
